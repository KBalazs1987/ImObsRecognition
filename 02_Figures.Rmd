...
```{r}
load("D:/CloudStation/pentamer_project/PNAS_revision/crossreact/simmatrix_nimtcems43")
...
chowell = chowell[is.na(fmatch(chowell$nmer, ligands_nonhuman$peptide)),] #3430
rm(ligands_nonhuman)
