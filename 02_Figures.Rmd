...
ggsave(fig1, filename = "D:/CloudStation/pentamer_project/PNAS_revision/main_plots_rs/Fig1_26.pdf", width = 22, height = 10, units = "cm", dpi = "retina")
```
...
```{r}
load("../articleplots_objects/stat_individual") #githubra megy
...
```{r}
load("D:/CloudStation/pentamer_project/objects/sars_cov_simil_to_balazs")
...
ggsave(fig3, filename = "D:/CloudStation/pentamer_project/PNAS_revision/main_plots_rs/Fig3_6.pdf", width = 22, height = 10, units = "cm", dpi = "retina")
rm(lay, margin)
```
...
tbl = read.delim("../crossreact/FIMMUN.txt", stringsAsFactors = F) #github
...
species = list.files("../objects/uniprot_proteomes_hla_binding/eps/") #mendeley, egyes proteomokban jelenlevo nonamereket tartalmazza
...
load("D:/CloudStation/pentamer_project/articleplots_objects/results_for_heatmaps")
alleles = sort(unique(res$alleles))
load("D:/CloudStation/pentamer_project/articleplots_objects/results_for_heatmaps_medians_locspec_sarsexpr_033_sarsthymo_025_previous_corrected.jpg") #github
res %<>% 
...
load("D:/CloudStation/pentamer_project/PNAS_revision/objects/all_iedb")
...
ggsave(figS2, filename = "D:/CloudStation/pentamer_project/PNAS_revision/supp_plots_rs/FigS2_18.png", width = 22, height = 13, units = "cm", dpi = "retina")
Sys.time()
rm(lay, margin1)
```
...
```{r}
load("ms_data_corrected2") #Mendeley
load("../objects/pentamerfreq_tcem")
...
```{r}
load("ligands_nonhuman_d1d2_wosecanc") #githubra
wilcox.test(freqpenta_tcem ~ immunogenicity, subset(ligands_nonhuman, dataset == "d1"))
wilcox.test(freqpenta_tcem ~ immunogenicity, subset(ligands_nonhuman, dataset == "d2"))
...
ggsave(figS9, filename = "D:/CloudStation/pentamer_project/PNAS_revision/supp_plots_rs/FigS9.pdf", width = 22, height = 10, units = "cm", dpi = "retina")
```
...
```{r}
chowell = read.delim("Chowell_st_ie.txt", sep = "\t", stringsAsFactors = F) #githubra
load("ligands_nonhuman_d1d2")
...
ggsave(figS10, filename = "D:/CloudStation/pentamer_project/PNAS_revision/supp_plots_rs/figS10_2.png", width = 11, height = 11, units = "cm", dpi = "retina")
...
#A6
tbl = read.delim("../crossreact/A6_position_depletion_matrix.csv", sep = ",", stringsAsFactors = F) #githubra
