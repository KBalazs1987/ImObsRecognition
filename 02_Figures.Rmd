...
rm(ligands_nonhuman)
dropped_ep = readLines("dropped_eps_clo_d2.txt")
...
ggplot(tcems_f, aes(x = freqpenta_tcem, color = tcemsource, fill = tcemsource)) +
  ...
  theme(
    ...
    strip.background = element_blank(),
    strip.placement = "outside")
#ggsave("FigS3.jpg", width = 14, height = 14, units = "cm", dpi = "retina")
...
#ggsave(figs4_ms, filename = "figS4.png", width = 20, height = 13, units = "cm", dpi = "retina")
```
...
#save(resanova, file = "resanova_d1")
...
rm(modelglm, modelglm1, tempanova, i)
#save(resanova, file = "resanova_d2")
```
...
#ggsave(fig_forest, filename = "figS8.png", width = 13, height = 8, units = "cm", dpi = "retina")
```
...
```{r}
chowell = read.delim("Chowell_st_ie.txt", sep = "\t", stringsAsFactors = F) #9888
load("ligands_nonhuman_d1d2")
